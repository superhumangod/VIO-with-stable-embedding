...
#ifndef SIEKF_MSCKF_VIO_H
#define SIEKF_MSCKF_VIO_H
...
class SiekfVio {
  public:
    ...
    // Constructor
    SiekfVio(ros::NodeHandle& pnh);
    // Disable copy and assign constructor
    SiekfVio(const SiekfVio&) = delete;
    SiekfVio operator=(const SiekfVio&) = delete;
    ...
    typedef boost::shared_ptr<SiekfVio> Ptr;
    typedef boost::shared_ptr<const SiekfVio> ConstPtr;
...
typedef SiekfVio::Ptr SiekfVioPtr;
typedef SiekfVio::ConstPtr SiekfVioConstPtr;
